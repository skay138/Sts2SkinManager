...
public static class Strings
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> _tables = new(StringComparer.OrdinalIgnoreCase)
    {
        ["ENG"] = new()
        {
            ...
            ["junction_modal_title"] = "Sts2 Skin Manager — Mod folder relinked",
            ["junction_modal_body"] = "A mod folder was found inside a category subfolder. A directory junction has been created at mods/ so the game can discover it again.\n\nRestart STS2 once to load the relinked mod.\n\nAuto-restart in {0}s via Steam.",
        ...
        ["KOR"] = new()
        {
            ...
            ["junction_modal_title"] = "Sts2 스킨 매니저 — mod 폴더 재연결",
            ["junction_modal_body"] = "카테고리 하위 폴더 안에서 mod 를 발견했어요.\n게임이 다시 찾을 수 있도록 mods/ 에 디렉터리 junction 을 만들었어요.\n\n재연결된 mod 를 로드하려면 STS2 를 한 번 재시작해 주세요.\n\n{0}초 뒤 자동으로 재시작됩니다.",
        ...
        ["JPN"] = new()
        {
            ...
            ["junction_modal_title"] = "Sts2 スキンマネージャー — mod フォルダ再リンク",
            ["junction_modal_body"] = "カテゴリのサブフォルダ内に mod を見つけました。\nゲームが再認識できるよう mods/ にディレクトリジャンクションを作成しました。\n\n再リンクされた mod を読み込むため STS2 を一度再起動してください。\n\n{0}秒後にSteamで自動再起動します。",
        ...
        ["ZHS"] = new()
        {
            ...
            ["junction_modal_title"] = "Sts2 皮肤管理器 — mod 文件夹已重新链接",
            ["junction_modal_body"] = "在分类子文件夹中发现了 mod。\n已在 mods/ 创建目录连接(junction),便于游戏重新识别。\n\n请重启 STS2 一次以加载已重新链接的 mod。\n\n将在 {0} 秒后通过 Steam 自动重启。",
        ...
        ["ZHT"] = new()
        {
            ...
            ["junction_modal_title"] = "Sts2 皮膚管理器 — mod 資料夾已重新連結",
            ["junction_modal_body"] = "在分類子資料夾中發現了 mod。\n已在 mods/ 建立目錄連結(junction),以便遊戲重新識別。\n\n請重新啟動 STS2 一次以載入已重新連結的 mod。\n\n將在 {0} 秒後透過 Steam 自動重新啟動。",
